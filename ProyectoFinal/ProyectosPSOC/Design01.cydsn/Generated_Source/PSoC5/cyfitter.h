...
/* Entrada */
#define Entrada__0__INTTYPE CYREG_PICU1_INTTYPE7
#define Entrada__0__MASK 0x80u
#define Entrada__0__PC CYREG_PRT1_PC7
#define Entrada__0__PORT 1u
#define Entrada__0__SHIFT 7u
#define Entrada__AG CYREG_PRT1_AG
#define Entrada__AMUX CYREG_PRT1_AMUX
#define Entrada__BIE CYREG_PRT1_BIE
#define Entrada__BIT_MASK CYREG_PRT1_BIT_MASK
#define Entrada__BYP CYREG_PRT1_BYP
#define Entrada__CTL CYREG_PRT1_CTL
#define Entrada__DM0 CYREG_PRT1_DM0
#define Entrada__DM1 CYREG_PRT1_DM1
#define Entrada__DM2 CYREG_PRT1_DM2
#define Entrada__DR CYREG_PRT1_DR
#define Entrada__INP_DIS CYREG_PRT1_INP_DIS
#define Entrada__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Entrada__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Entrada__LCD_EN CYREG_PRT1_LCD_EN
#define Entrada__MASK 0x80u
#define Entrada__PORT 1u
#define Entrada__PRT CYREG_PRT1_PRT
#define Entrada__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Entrada__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Entrada__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Entrada__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Entrada__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Entrada__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Entrada__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Entrada__PS CYREG_PRT1_PS
#define Entrada__SHIFT 7u
#define Entrada__SLW CYREG_PRT1_SLW

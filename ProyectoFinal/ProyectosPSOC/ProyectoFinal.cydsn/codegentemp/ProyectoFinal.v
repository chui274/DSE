// ======================================================================
// ProyectoFinal.v generated from TopDesign.cysch
// 09/18/2016 at 19:07
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6a2503c1-137d-4b13-91d8-bea49d0728c5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_70_2 TimeDistMeas (
        ...
        .tc(Net_35),
        .clock(Net_213));
    defparam TimeDistMeas.CaptureCount = 2;
    defparam TimeDistMeas.CaptureCounterEnabled = 0;
    defparam TimeDistMeas.DeviceFamily = "PSoC5";
    defparam TimeDistMeas.InterruptOnCapture = 0;
    defparam TimeDistMeas.InterruptOnTC = 0;
    defparam TimeDistMeas.Resolution = 16;
    defparam TimeDistMeas.SiliconRevision = "0";

    CyControlReg_v1_80 Triggen (
        .control_1(Net_36),
        .control_2(Net_37),
        .control_3(Net_38),
        .control_0(Net_12),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Triggen.Bit0Mode = 0;
    defparam Triggen.Bit1Mode = 0;
    defparam Triggen.Bit2Mode = 0;
    defparam Triggen.Bit3Mode = 0;
    defparam Triggen.Bit4Mode = 0;
    defparam Triggen.Bit5Mode = 0;
    defparam Triggen.Bit6Mode = 0;
    defparam Triggen.Bit7Mode = 0;
    defparam Triggen.BitValue = 0;
    defparam Triggen.BusDisplay = 0;
    defparam Triggen.ExtrReset = 0;
    defparam Triggen.NumOutputs = 1;
	...
	wire [0:0] tmpOE__DistOutHCSRO4_net;
	wire [0:0] tmpIO_0__DistOutHCSRO4_net;
	wire [0:0] tmpINTERRUPT_0__DistOutHCSRO4_net;
	electrical [0:0] tmpSIOVREF__DistOutHCSRO4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		DistOutHCSRO4
		 (.oe(tmpOE__DistOutHCSRO4_net),
		  .y({1'b0}),
		  .fb({Net_62}),
		  .io({tmpIO_0__DistOutHCSRO4_net[0:0]}),
		  .siovref(tmpSIOVREF__DistOutHCSRO4_net),
		  .interrupt({tmpINTERRUPT_0__DistOutHCSRO4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DistOutHCSRO4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__foto_net;
	wire [0:0] tmpFB_0__foto_net;
	wire [0:0] tmpIO_0__foto_net;
	wire [0:0] tmpINTERRUPT_0__foto_net;
	electrical [0:0] tmpSIOVREF__foto_net;
	...
	cy_psoc3_pins_v1_10
		...
		foto
		 (.oe(tmpOE__foto_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__foto_net[0:0]}),
		  .io({tmpIO_0__foto_net[0:0]}),
		  .siovref(tmpSIOVREF__foto_net),
		  .interrupt({tmpINTERRUPT_0__foto_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__foto_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__toma_net;
	wire [0:0] tmpIO_0__toma_net;
	wire [0:0] tmpINTERRUPT_0__toma_net;
	electrical [0:0] tmpSIOVREF__toma_net;

	cy_psoc3_pins_v1_10
		#(.id("e2321127-a61c-4f63-b353-fa776240b07a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		toma
		 (.oe(tmpOE__toma_net),
		  .y({1'b0}),
		  .fb({Net_316}),
		  .io({tmpIO_0__toma_net[0:0]}),
		  .siovref(tmpSIOVREF__toma_net),
		  .interrupt({tmpINTERRUPT_0__toma_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__toma_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

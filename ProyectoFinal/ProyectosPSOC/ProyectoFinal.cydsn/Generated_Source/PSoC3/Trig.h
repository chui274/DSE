...
*/
     ...
     */
        /* Drive Modes */
        #define Trig_DM_ALG_HIZ         PIN_DM_ALG_HIZ   /**< \brief High Impedance Analog   */
        #define Trig_DM_DIG_HIZ         PIN_DM_DIG_HIZ   /**< \brief High Impedance Digital  */
        #define Trig_DM_RES_UP          PIN_DM_RES_UP    /**< \brief Resistive Pull Up       */
        #define Trig_DM_RES_DWN         PIN_DM_RES_DWN   /**< \brief Resistive Pull Down     */
        #define Trig_DM_OD_LO           PIN_DM_OD_LO     /**< \brief Open Drain, Drives Low  */
        #define Trig_DM_OD_HI           PIN_DM_OD_HI     /**< \brief Open Drain, Drives High */
        #define Trig_DM_STRONG          PIN_DM_STRONG    /**< \brief Strong Drive            */
        #define Trig_DM_RES_UPDWN       PIN_DM_RES_UPDWN /**< \brief Resistive Pull Up/Down  */
    /** @} driveMode */
/** @} group_constants */
...
*/
     ...
     */
        ...
        #define Trig_INTR_RISING    (uint16)(0x0001u)   /**< \brief Rising edge trigger  */
        #define Trig_INTR_FALLING   (uint16)(0x0002u)   /**< \brief Falling edge trigger */
        #define Trig_INTR_BOTH      (uint16)(0x0003u)   /**< \brief Both edge trigger    */
        /** @} intrMode */
/** @} group_constants */

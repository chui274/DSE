...
/* pot */
#define pot__0__INTTYPE CYREG_PICU1_INTTYPE5
#define pot__0__MASK 0x20u
#define pot__0__PC CYREG_PRT1_PC5
...
/* Trig */
#define Trig__0__INTTYPE CYREG_PICU0_INTTYPE3
#define Trig__0__MASK 0x08u
#define Trig__0__PC CYREG_PRT0_PC3
#define Trig__0__PORT 0u
#define Trig__0__SHIFT 3u
...
#define Trig__SHIFT 3u
#define Trig__SLW CYREG_PRT0_SLW

/* foto */
#define foto__0__INTTYPE CYREG_PICU1_INTTYPE7
#define foto__0__MASK 0x80u
#define foto__0__PC CYREG_PRT1_PC7
#define foto__0__PORT 1u
#define foto__0__SHIFT 7u
#define foto__AG CYREG_PRT1_AG
#define foto__AMUX CYREG_PRT1_AMUX
#define foto__BIE CYREG_PRT1_BIE
#define foto__BIT_MASK CYREG_PRT1_BIT_MASK
#define foto__BYP CYREG_PRT1_BYP
#define foto__CTL CYREG_PRT1_CTL
#define foto__DM0 CYREG_PRT1_DM0
#define foto__DM1 CYREG_PRT1_DM1
#define foto__DM2 CYREG_PRT1_DM2
#define foto__DR CYREG_PRT1_DR
#define foto__INP_DIS CYREG_PRT1_INP_DIS
#define foto__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define foto__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define foto__LCD_EN CYREG_PRT1_LCD_EN
#define foto__MASK 0x80u
#define foto__PORT 1u
#define foto__PRT CYREG_PRT1_PRT
#define foto__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define foto__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define foto__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define foto__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define foto__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define foto__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define foto__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define foto__PS CYREG_PRT1_PS
#define foto__SHIFT 7u
#define foto__SLW CYREG_PRT1_SLW

/* toma */
#define toma__0__INTTYPE CYREG_PICU1_INTTYPE2
#define toma__0__MASK 0x04u
#define toma__0__PC CYREG_PRT1_PC2
#define toma__0__PORT 1u
#define toma__0__SHIFT 2u
#define toma__AG CYREG_PRT1_AG
#define toma__AMUX CYREG_PRT1_AMUX
#define toma__BIE CYREG_PRT1_BIE
#define toma__BIT_MASK CYREG_PRT1_BIT_MASK
#define toma__BYP CYREG_PRT1_BYP
#define toma__CTL CYREG_PRT1_CTL
#define toma__DM0 CYREG_PRT1_DM0
#define toma__DM1 CYREG_PRT1_DM1
#define toma__DM2 CYREG_PRT1_DM2
#define toma__DR CYREG_PRT1_DR
#define toma__INP_DIS CYREG_PRT1_INP_DIS
#define toma__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define toma__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define toma__LCD_EN CYREG_PRT1_LCD_EN
#define toma__MASK 0x04u
#define toma__PORT 1u
#define toma__PRT CYREG_PRT1_PRT
#define toma__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define toma__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define toma__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define toma__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define toma__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define toma__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define toma__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define toma__PS CYREG_PRT1_PS
#define toma__SHIFT 2u
#define toma__SLW CYREG_PRT1_SLW
...
#define Triggen_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB02_03_ACTL
#define Triggen_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB02_03_CTL
#define Triggen_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB02_03_CTL
#define Triggen_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB02_03_CTL
#define Triggen_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB02_03_CTL
#define Triggen_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B0_UDB02_03_MSK
#define Triggen_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB02_03_MSK
#define Triggen_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB02_03_MSK
#define Triggen_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB02_03_MSK
#define Triggen_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B0_UDB02_ACTL
#define Triggen_Sync_ctrl_reg__CONTROL_REG CYREG_B0_UDB02_CTL
#define Triggen_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B0_UDB02_ST_CTL
#define Triggen_Sync_ctrl_reg__COUNT_REG CYREG_B0_UDB02_CTL
#define Triggen_Sync_ctrl_reg__COUNT_ST_REG CYREG_B0_UDB02_ST_CTL
#define Triggen_Sync_ctrl_reg__MASK 0x01u
#define Triggen_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define Triggen_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define Triggen_Sync_ctrl_reg__PERIOD_REG CYREG_B0_UDB02_MSK
...
/* DistOutHCSRO4 */
#define DistOutHCSRO4__0__INTTYPE CYREG_PICU0_INTTYPE2
#define DistOutHCSRO4__0__MASK 0x04u
#define DistOutHCSRO4__0__PC CYREG_PRT0_PC2
#define DistOutHCSRO4__0__PORT 0u
#define DistOutHCSRO4__0__SHIFT 2u
#define DistOutHCSRO4__AG CYREG_PRT0_AG
#define DistOutHCSRO4__AMUX CYREG_PRT0_AMUX
#define DistOutHCSRO4__BIE CYREG_PRT0_BIE
#define DistOutHCSRO4__BIT_MASK CYREG_PRT0_BIT_MASK
#define DistOutHCSRO4__BYP CYREG_PRT0_BYP
#define DistOutHCSRO4__CTL CYREG_PRT0_CTL
#define DistOutHCSRO4__DM0 CYREG_PRT0_DM0
#define DistOutHCSRO4__DM1 CYREG_PRT0_DM1
#define DistOutHCSRO4__DM2 CYREG_PRT0_DM2
#define DistOutHCSRO4__DR CYREG_PRT0_DR
#define DistOutHCSRO4__INP_DIS CYREG_PRT0_INP_DIS
#define DistOutHCSRO4__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define DistOutHCSRO4__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define DistOutHCSRO4__LCD_EN CYREG_PRT0_LCD_EN
#define DistOutHCSRO4__MASK 0x04u
#define DistOutHCSRO4__PORT 0u
#define DistOutHCSRO4__PRT CYREG_PRT0_PRT
#define DistOutHCSRO4__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define DistOutHCSRO4__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define DistOutHCSRO4__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define DistOutHCSRO4__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define DistOutHCSRO4__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define DistOutHCSRO4__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define DistOutHCSRO4__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define DistOutHCSRO4__PS CYREG_PRT0_PS
#define DistOutHCSRO4__SHIFT 2u
#define DistOutHCSRO4__SLW CYREG_PRT0_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "ProyectoFinal"

...
#define TimeDistMeas_UsingFixedFunction         1u
...
#define TimeDistMeas_UsingHWEnable              1u
#define TimeDistMeas_EnableTriggerMode          0u
#define TimeDistMeas_InterruptOnCaptureCount    0u
#define TimeDistMeas_RunModeUsed                0u
...
#define TimeDistMeas_INIT_CAPTURE_MODE       ((uint8)((uint8)0u << TimeDistMeas_CTRL_CAP_MODE_SHIFT))
#define TimeDistMeas_INIT_TRIGGER_MODE       ((uint8)((uint8)0u << TimeDistMeas_CTRL_TRIG_MODE_SHIFT))
#if (TimeDistMeas_UsingFixedFunction)
